    ...
    public Boolean validate(){
        ...
        else 
        {
            try{
                ...
                if(mobile.length()<10)
                    JOptionPane.showMessageDialog(new JFrame(), "Enter ten numbers ","Inane error", JOptionPane.ERROR_MESSAGE);
                else
                    valid = true;
                }
            catch(NumberFormatException e){
                JOptionPane.showMessageDialog(new JFrame(), "Enter only numbers ","Inane error", JOptionPane.ERROR_MESSAGE);    
            }
        }
